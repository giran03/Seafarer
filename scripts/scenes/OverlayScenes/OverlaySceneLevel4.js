export default class OverlaySceneLevel4 extends Phaser.Scene
{
    constructor() { 
        super('OverlaySceneLevel4')

        this.GameScene = 'GameSceneLevel4'
    ...
    create() {
        ...
        const levelText = this.add.text(this.screenCenterX*.57, this.screenCenterY*.05, 'Level: 4 ', {
            fontSize: '20px', 
            fill: '#ffe863' , 
            fontFamily: 'stackedPixel'
        }).setShadow(2, 2, '#000', 5, true, true).setOrigin(.5)
